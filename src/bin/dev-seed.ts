...
async function ensureLedgerFields(assetUuid: string, ledger: NonNullable<SeedAsset['ledger']>, recordedAt: Date) {
  ...
  return prisma.assetLedgerFields.create({
    data: {
      assetUuid,
      regionOverride: ledger.region ?? null,
      companyOverride: ledger.company ?? null,
      departmentOverride: ledger.department ?? null,
      systemCategoryOverride: ledger.systemCategory ?? null,
      systemLevelOverride: ledger.systemLevel ?? null,
      bizOwnerOverride: ledger.bizOwner ?? null,
      maintenanceDueDateOverride: ledger.maintenanceDueDate ?? null,
      purchaseDateOverride: ledger.purchaseDate ?? null,
      bmcIpOverride: ledger.bmcIp ?? null,
      cabinetNoOverride: ledger.cabinetNo ?? null,
      rackPositionOverride: ledger.rackPosition ?? null,
      managementCodeOverride: ledger.managementCode ?? null,
      fixedAssetNoOverride: ledger.fixedAssetNo ?? null,
